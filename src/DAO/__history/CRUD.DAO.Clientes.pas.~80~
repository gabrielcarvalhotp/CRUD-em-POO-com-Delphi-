...
type
  ...
  public
    ...
    procedure DeleteCliente(aValue: integer);
  end;
...
var
  lSQL: string;
begin
  lSql := ' delete from CLIENTES where CLIENTES.ID = :pId ';
  FDMcliente.PrepareStatement(lSQL);
  FDMcliente.AddParaments('pid', aValue);  
  FDMcliente.ExecSQL;
end;
